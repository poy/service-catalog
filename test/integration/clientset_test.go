...
import (
	...
	servicecatalogclient "github.com/poy/service-catalog/pkg/client/clientset_generated/clientset"
...
// TestClusterServiceBrokerClient exercises the ClusterServiceBroker client.
...
// TestNamespacedServiceBrokerClient exercises the namespaced ServiceBroker client.
...
func testNamespacedServiceBrokerClient(client servicecatalogclient.Interface, namespace, name string) error {
	...
	authSecret := &v1beta1.LocalObjectReference{
		Name: "test-name",
	}
	...
	brokerUpdated.Status = v1beta1.ServiceBrokerStatus{
		CommonServiceBrokerStatus: v1beta1.CommonServiceBrokerStatus{
			Conditions: []v1beta1.ServiceBrokerCondition{
				readyConditionTrue,
			},
...
// TestNamespacedServiceClassClient exercises the namespaced ServiceClass client.
...
func testNamespacedServiceClassClient(client servicecatalogclient.Interface, namespace, name string) error {
	...
	sc2Name := name + "2"
	sc2ID := "someotheridhere"
	serviceClass2 := &v1beta1.ServiceClass{
		ObjectMeta: metav1.ObjectMeta{Name: sc2Name},
		Spec: v1beta1.ServiceClassSpec{
			ServiceBrokerName: "test-broker",
			CommonServiceClassSpec: v1beta1.CommonServiceClassSpec{
...
// TestNamespacedServicePlanClient exercises the namespaced ServicePlan client.
...
func testNamespacedServicePlanClient(client servicecatalogclient.Interface, namespace, name string) error {
	...
	sp2Name := name + "2"
	sp2ID := "anotheridhere"
	servicePlan2 := &v1beta1.ServicePlan{
		ObjectMeta: metav1.ObjectMeta{Name: sp2Name},
		Spec: v1beta1.ServicePlanSpec{
			ServiceBrokerName: "test-broker",
			CommonServicePlanSpec: v1beta1.CommonServicePlanSpec{
