...
SC_PKG         = github.com/poy/service-catalog
...
BASE_PATH      = $(ROOT:/src/github.com/poy/service-catalog/=)
...
build-integration: .generate_files
	$(DOCKER_CMD) go test -race github.com/poy/service-catalog/test/integration/... -c
