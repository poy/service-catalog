...
import (
	...
	"github.com/poy/service-catalog/pkg/util"
	"k8s.io/klog"

	"github.com/poy/service-catalog/contrib/pkg/brokerapi/openservicebroker/constants"
)
...
func (c *openServiceBrokerClient) UpdateServiceInstance(ID string, req *brokerapi.CreateServiceInstanceRequest) (*brokerapi.ServiceInstance, int, error) {
	// TODO: https://github.com/poy/service-catalog/issues/114
